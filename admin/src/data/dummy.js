...
import { AiOutlineCheck, AiOutlineClose, AiOutlineCalendar, AiOutlineShoppingCart, AiOutlineAreaChart, AiOutlineBarChart, AiOutlineStock } from 'react-icons/ai';
import { FiRadio, FiEdit, FiPieChart, FiCreditCard, FiStar, FiShoppingCart } from 'react-icons/fi';
...
import {convertToDate, isExpired} from '../constants'
import { handleConfirmClick } from './handleDummyEvents';
import { Popconfirm } from 'antd';

export const gridOrderImage = (props) => (
  <div>
    <img
      className="rounded-xl w-24 h-20 object-cover md:ml-3"
      src={props.image}
      alt="order-item"
    />
  </div>
...
export const gridOrderStatus = (props) => (
  <div>
    {
      isExpired(props.deadline) ? <span className='text-red-500'>Expired</span> : 
      <span className='text-yellow-500'>{props.status}</span>
    }
  </div>
);
...
export const gridProjectStatus = (props) => (
  <p>
    {
      isExpired(props.deadline) ? <span className='text-red-500'>Expired</span> : 
      <span className='text-green-500'>{props.status}</span>
    }
  </p>
);
...
export const gridOrderDate = (props) => (
  <p>
    {convertToDate(props.deadline) }
  </p>
);

export const gridOrderConfirm = (props) => (
  <div className='flex flex-row items-center justify-center bg-green w-full'>
    <Popconfirm
    placement="topLeft"
    title={"Đồng ý?"}
    description={"Hành động này sẽ cho phép dự án này hoạt động."}
    onConfirm={() => handleConfirmClick(1, props)}
    onCancel={() => {}}
    okText="Yes"
    cancelText="No"
  >
     <button type='button'
    className='text-green-500 p-2 hover:bg-green-500 hover:text-white transition-all rounded-sm'
    >
    <AiOutlineCheck />
    </button>
  </Popconfirm>
  ...
  placement="topLeft"
    title={"Từ chối?"}
    description={"Từ chối cho dự án này hoạt động vì dự án chưa đạt yêu cầu."}
    onConfirm={() => handleConfirmClick(0, props)}
    onCancel={() => {}}
    okText="Yes"
    cancelText="No"
  >
    <button type='button'
    className='text-red-500 p-2 hover:bg-red-500 hover:text-white transition-all rounded-sm ml-2'
    >
    <AiOutlineClose />
    </button>
    </Popconfirm>
...
export const gridOrderAmount = (props) => (
...
export const gridOrderAuthor = (props) => (
  <p>
    {props.user.orgName}
  </p>
);
...
const customerGridStatus = (props) => (
  <div className="flex gap-2 justify-center items-center text-gray-700 capitalize">
    <p style={{ background: props.verified ? 'green' : 'gray' }} className="rounded-full h-2 w-2" />
  </div>
);
...
export const links = [
...

  {
    ...
    links: [
      {
        name: 'queue',
        displayText: 'Dự án đang đợi',
        icon: <AiOutlineShoppingCart />,
      },
      {
        name: 'projects',
        displayText: 'Tất cả dự án',
        icon: <IoMdContacts />,
      },
      {
        name: 'users',
