...
class ContentBasedRecommender:
    ...
    def recommend(self, input_text, top_n=5):
        ...
        # Lấy danh sách các item có độ tương tự lớn hơn hoặc bằng 0.2
        related_items_indices = [idx for idx, similarity in enumerate(cosine_similarities) if similarity >= 0.2]
