...
const CountBox = ({ title, value, icon, timer }) => {
  ...
  return (
    <div className="w-full">
      <div className="h-[96px] flex items-center justify-center p-3 bg-[#f2f2f2] dark:bg-[#1c1c24] rounded-t-[6px] w-full">
        <h4
          className={`font-epilogue text-[28px] leading-8 font-bold break-words text-[#111111] dark:text-white uppercase text-center`}
        >
